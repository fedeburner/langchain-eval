...
This started as a barebones CLI chat agent on [LangChain Deep Agents](https://github.com/langchain-ai/deepagents). I took it and built out six different memory strategies, an evaluation harness to systematically test them, and a Streamlit dashboard to dig into the results.
